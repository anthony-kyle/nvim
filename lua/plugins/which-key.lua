    ...
    config = function()
      require('which-key').setup {
        ...
        spec = {
          ...
          { '<leader>pg', name = 'Telescope [G]it', icon = '', mode = { 'n' } },
          { '<leader>pc', name = 'Telescope [C]ommands', icon = '', mode = { 'n' } },
          { '<leader>pb', name = 'Telescope [B]uffers', icon = '', mode = { 'n' } },
          { '<leader>po', name = 'Telescope [O]ld Files', icon = '󰈙', mode = { 'n', 'v' } },
          { '<leader>ph', name = 'Telescope Search [H]istory', icon = '󰒡', mode = { 'n', 'v' } },
          ...
          { '<leader>mb', name = '[B]uffers', icon = '󰕮', mode = { 'n', 'v' } },
          { '<leader>mt', name = '[T]ab', icon = '󰕮', mode = { 'n', 'v' } },
          { '<leader>mw', name = '[W]indow', icon = '󰕮', mode = { 'n', 'v' } },
